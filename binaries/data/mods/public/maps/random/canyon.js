...
{
	var ix = randIntExclusive(1, mapSize);
	var iz = randIntExclusive(1, mapSize);
	var ix2 = randIntExclusive(1, mapSize);
	var iz2 = randIntExclusive(1, mapSize);
...
{
	var tx = randIntExclusive(1, mapSize);
	var tz = randIntExclusive(1, mapSize);
